...
* <details>
  ...
  <ul>
    ...
    <li><strong>AI:</strong> ChatGPT API, Claude.AI API, DeepSeek API</li>
...
[![My Skills](https://skillicons.dev/icons?i=gitlab,git,postman,docker,gcp)](https://skillicons.dev)
